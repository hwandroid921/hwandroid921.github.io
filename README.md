...
<!-- 📌 아래 경로에 실제 GIF를 교체해주세요 -->
![회원 기능](./docs/gif/member.gif)
...
<!-- 📌 아래 경로에 실제 GIF를 교체해주세요 -->
![관광지 기능](./docs/gif/attraction.gif)

---

### ⭐ 리뷰
> 관광지별 리뷰 작성/수정/삭제, 이미지 첨부, 관광지 상세페이지에서 최근 리뷰 5개 미리보기

<!-- 📌 아래 경로에 실제 GIF를 교체해주세요 -->
![리뷰 기능](./docs/gif/review.gif)

---

### 🏨 숙박 안내
> 호텔/리조트/펜션/게스트하우스/민박 카테고리별 조회, 다중 이미지 지원

<!-- 📌 아래 경로에 실제 GIF를 교체해주세요 -->
![숙박 기능](./docs/gif/accommodation.gif)
...
<!-- 📌 아래 경로에 실제 GIF를 교체해주세요 -->
![커뮤니티 기능](./docs/gif/community.gif)
