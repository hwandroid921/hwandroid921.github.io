package com.shop.basicwear.account.helper;

import com.shop.basicwear.account.dto.AccountJoinRequest;
import com.shop.basicwear.account.dto.AccountLoginRequest;
import com.shop.basicwear.account.etc.AccountConstants;
import com.shop.basicwear.common.util.HttpUtils;
import com.shop.basicwear.member.entity.Member;
import com.shop.basicwear.member.service.MemberService;
...
public class SessionAccountHelper implements AccountHelper {
    ...
    // 로그인
    @Override
    public String login(AccountLoginRequest loginReq, HttpServletRequest req, HttpServletRequest res) {
