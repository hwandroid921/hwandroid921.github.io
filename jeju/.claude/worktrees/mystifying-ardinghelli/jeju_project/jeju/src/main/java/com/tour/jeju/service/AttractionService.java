...
public class AttractionService {
    ...
    // 관광지 추가
    @Transactional
<<<<<<<< HEAD:jeju/.claude/worktrees/mystifying-ardinghelli/jeju_project/jeju/src/main/java/com/tour/jeju/service/AttractionService.java
    ...
    public AttractionResponse editAttraction(Long id,
        ...
        return AttractionResponse.fromEntity(
                ...
                reviewRepository.findTop5ByAttractionIdOrderByCreatedAtDesc(id)
                        ...
                        .map(ReviewResponse::fromEntity)
                        .collect(Collectors.toList())
>>>>>>>> 31bd79988529b81c7888e4640ae298bbf0f89c36:jeju/src/main/java/com/tour/jeju/service/AttractionService.java
        );
    }
